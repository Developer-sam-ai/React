...
return (
    ...
    <div className=' bg-slate-950 h-screen' >
        ...
        <div >
            ...
            className="w-full h-44 flex-1 m-4 bg-slate-900 text-white placeholder-slate-500 p-4 rounded-xl border border-slate-700 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none transition-all"></textarea>
        </div>
    </div>
    </>
)
