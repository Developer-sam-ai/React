...
<div className="flex font-sans" >
  ...
  <form class="flex-auto p-6">
    ...
    <div class="flex-auto flex space-x-4">
        <button class="h-10 px-6 font-semibold rounded-full bg-violet-600 text-white items-center" type="submit">
        Buy now
        </button>
        <button class="h-10 px-6 font-semibold rounded-full border border-slate-200 text-slate-900 items-center" type="button">
        Add to bag
        </button>
    </div>
